...
import br.fucapi.monitori.model.enums.TipoOrdemEnum;
...
public class GenericDAO<T extends AbstractEntityBean> implements Serializable {
	...
	public List<T> listar(String ordenadoPor) {
		return em.createQuery(("From " + classe.getName())+" order by "+ordenadoPor).getResultList();
	}
