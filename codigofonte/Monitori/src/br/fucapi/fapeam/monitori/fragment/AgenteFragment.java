...
public class AgenteFragment extends Fragment {
	...
	//Colecao de agentes a serem exibidos na tela
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {		
		...
		View layout = inflater.inflate(R.layout.agente, container, false);
		...
		//Ligacao dos componentes de TELA aos atributos da Activity
				...
				lvListagem.setOnItemLongClickListener(new OnItemLongClickListener() {
					...
					public boolean onItemLongClick(AdapterView<?> adapter, View view,
						...
						usuarioSelecionado = (Agente) adapter.getItemAtPosition(posicao);
				...
				lvListagem.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> adapter, View view,
						...
						usuarioSelecionado = (Agente) lvListagem
	...
	public void carregarLista(){
		...
		this.adapter = new ArrayAdapter<Usuario>(getActivity(), adapterLayout, listaAgente);
